...
# deploy cfn
aws cloudformation deploy --template ./packaged-template.json --stack-name emercado-tier-2-cicd-stack  --capabilities CAPABILITY_IAM --region ap-southeast-1 --profile apper
